...
<div id="PIBitacora" class="card" style="margin-top: 50px">
    <div class="modal-header text-center text-white green-grad">
        <h3 class="modal-title w-100 font-weight-bold">Bitacora</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                onclick="$('#PIBitacora').fadeOut();"
...
<div class="row">
        <div class="col-sm-12">
            <table id="tbBitacoraMostrar" class="table table-sm table-hover w3-border" width="99%">
                <thead class="primary-color text-white">
        <tr>
                    <th class="">Usuario</th>
                    <th class="">Fechar/Hora</th>
                    <th class="">Operacion</th>
                    <th class="">Tabla Afectada</th>
...
<script src="./js/js_Bitacora.js"></script>
