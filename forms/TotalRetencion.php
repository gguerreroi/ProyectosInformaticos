...
<div id="PITotalRetencion" class="card" style="margin-top: 50px">
    <div class="modal-header text-center text-white green-grad">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                onclick="$('#PITotalRetencion').fadeOut();"
...
<div class="row">
        <div class="col-sm-12">
            <table id="tbTotalRetencionMostrar" class="table table-sm table-hover w3-border" width="99%">
                <thead class="primary-color text-white">
        <tr>
                    <th class="">Nit del Proveedor</th>
                    <th class="">Numero de Factura</th>
                    <th class="">Total Retencion</th>
...
<script src="./js/js_TotalRetencion.js"></script>